...
public class AuthPresenterImpl implements AuthPresenter {
  ...
  public void registerAccount(String email, String password) {
    if(TextUtils.isStringEmptyorNull(email) && validateEmail(email)) {
  ...
  public void logInUser(String email, String password) {
    view.showProgress();
    if(TextUtils.isStringEmptyorNull(email)) {
      view.showErrorEmail();
      view.hideProgress();
    }
    else if(TextUtils.isStringEmptyorNull(password)) {
  ...
  public void validatePassword(String password, String confirmPassword) {
    ...
    if (!TextUtils.isStringEmptyorNull(password, confirmPassword) && password.equals(confirmPassword)) {
